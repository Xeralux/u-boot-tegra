...
#ifndef _SENSITY_MERLIN_TX2_H
#define _SENSITY_MERLIN_TX2_H
...
#define CONFIG_TEGRA_BOARD_STRING	"Sensity Merlin-TX2"
...
/* Environment in eMMC, at start of 2nd "boot sector" */
