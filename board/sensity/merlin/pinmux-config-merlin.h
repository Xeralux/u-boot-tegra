...
static const struct pmux_pingrp_config merlin_pingrps[] = {
	...
	PINCFG(DAP1_FS_PB0,          DEFAULT,    NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	PINCFG(DAP1_DIN_PB1,         DEFAULT,    NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	PINCFG(DAP1_DOUT_PB2,        DEFAULT,    NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
	PINCFG(DAP1_SCLK_PB3,        DEFAULT,    NORMAL, NORMAL,   INPUT,   DISABLE, DEFAULT),
